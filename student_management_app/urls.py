...
urlpatterns = [
    ...
    path('add_syllabus/', HodViews.add_syllabus, name="add_syllabus"),
    path('add_staff_save/', HodViews.add_staff_save, name="add_staff_save"),
    path('manage_syllabus/', HodViews.manage_syllabus, name="manage_syllabus"),
    ...
    path('export_csv/', HodViews.export_syllabus_csv, name="export_csv"),
    ...
    path('edit_syllabus/<int:syllabus_id>/', HodViews.edit_syllabus, name="edit_syllabus"),
    path('student_syllabus/', StudentViews.student_syllabus, name="student_syllabus"),
    path('edit_student/<student_id>', HodViews.edit_student, name="edit_student"),
    path('edit_student_save/', HodViews.edit_student_save, name="edit_student_save"),
    path('syllabus_action/<int:syllabus_id>/', HodViews.syllabus_action, name="syllabus_action"),
    path('generate_pdf/<int:syllabus_id>/', HodViews.generate_pdf, name="generate_pdf"),
    ...
    path('staff_syllabus/', StaffViews.staff_syllabus_list, name="staff_syllabus_list"),
    path('staff_syllabus/add/', StaffViews.staff_syllabus_create, name="staff_syllabus_create"),
    path('staff_syllabus/edit/<int:syllabus_id>/', StaffViews.staff_syllabus_edit, name="staff_syllabus_edit"),
    path('staff_syllabus/submit/<int:syllabus_id>/', StaffViews.staff_syllabus_submit, name="staff_syllabus_submit"),
    path('staff_syllabus/pdf/<int:syllabus_id>/', StaffViews.staff_generate_pdf, name="staff_generate_pdf"),
    ...
    path('student_syllabus/pdf/<int:syllabus_id>/', StudentViews.student_generate_pdf, name="student_generate_pdf"),
]
